...
// ponytail: a starter denylist for adult platforms — a heuristic, not exhaustive.
// Upgrade path: a real classifier / moderation queue if it starts getting gamed.
const NSFW_HOSTS = new Set([
  "pornhub.com",
  "xvideos.com",
  "xnxx.com",
  "onlyfans.com",
...
export function parseIdentity(input: {
  ...
  if (NSFW_HOSTS.has(host) || NSFW_HOSTS.has(rootHost)) {
    throw new Error("Adult / NSFW links are not allowed");
  }
